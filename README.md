...
This is a python script to build a catalog of your RASC_finest_NGC_objects  astrophotographies
...
Place the "RASC_generator.py" script and the "RASC.bat" file in the same folder. Double-click on RASC.bat, accept the Windows prompts, and it generates an interactive HTML contact sheet.
...
You can easily translate the script in any langage as all strings are gathered at the top of the script... Meanwhile in french exce^t the object description in english!
